...
public class FlooringMasteryDaoFileImpl implements FlooringMasteryDao {
    ...
    private void writeOrders(String date, Map map) throws FlooringMasteryPersistenceException {
        PrintWriter out;
...
String dateFormatted = ld.format(formatter);*/

//Save new orders
/*if (newOrdersMap.size() > 0) {
loadOrders(dateFormatted);
if (ordersMap.size() > 0) {
ordersMap.putAll(newOrdersMap);
writeOrders(dateFormatted, ordersMap);
} else {
writeOrders(dateFormatted, newOrdersMap);
}
}*/
//**********************************************************************