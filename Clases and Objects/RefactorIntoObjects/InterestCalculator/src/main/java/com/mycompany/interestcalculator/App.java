...
public class App {
    ...
    public static void main(String[] args) {
        ...
        iCal.setCapital(Double.parseDouble(ConsoleIO.inputMessage("How much money will you deposit?")));
        iCal.setInterestRt(Double.parseDouble(ConsoleIO.inputMessage("What's the annual interest rate?"))); 
